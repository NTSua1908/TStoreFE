    ...
    return(
        <div className="SliderGameDetail">
            <div className="SliderGameDetail__slider">
              <Swiper className='SliderGameDetail__mainslider'
                grabCursor={true}
                autoplay={{
                  delay: 2500,
                ...
                modules={[Autoplay,FreeMode, Navigation, Thumbs]}>
                {
                    gameItems.map((item, i) => (
                        <SwiperSlide key={i}>
                            <img className="SliderGameDetail__mainslider__imgGame" src={item.img} alt=""/>
                        </SwiperSlide>
                    ))
                }
              </Swiper>

              <Swiper className='SliderGameDetail__thumbslider'
                    ...
                    gameItems.map((item, i) => (
                        <SwiperSlide key={i}>
                          <div className="SliderGameDetail__thumbslider__container">
                            <img className="SliderGameDetail__thumbslider__imgGame" src={item.img} alt=""/>
                          </div>
                        </SwiperSlide>
                    ))
                }
