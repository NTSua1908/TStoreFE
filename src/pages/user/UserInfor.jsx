            ...
            <div className="UserInfor__wrapper">
                <div className="UserInfor__wrapper__Menu">
                    <div className="UserInfor__wrapper__Menu__accountsidebar">
                        <h3 className="UserInfor__wrapper__Menu__accounttitle">Tài khoản</h3>
                    </div>
                ...
                <div className="UserInfor__wrapper__Information">
                    ...
                    <form action="" acceptCharset="UTF-8" method="post">
                        <div className="UserInfor__wrapper__Information__email">
                            <label className="UserInfor__wrapper__Information__label">Email</label>
                            <Input disabled/>
                        </div>

                        <div className="UserInfor__wrapper__Information__surname">
                            <label className="UserInfor__wrapper__Information__label">Họ và tên đệm</label>
                            <Input/>
                        </div>

                        <div className="UserInfor__wrapper__Information__name">
                            <label className="UserInfor__wrapper__Information__label">Tên</label>
                            <Input/>
                        </div>
                        ...
                        >
                            <label className="UserInfor__wrapper__Information__label">Giới tính</label>
                            <ul>
                                <li>
                                    <input id="radio1" type="radio" value="FEMALE" name="gender"/>
                        ...
                        <div className="UserInfor__wrapper__Information__birthday">
                            <label className="UserInfor__wrapper__Information__label">Ngày sinh</label>
                            <Input isDate small/>
                        </div>

                        <button className="UserInfor__wrapper__Information__confirm">Cập nhật</button>     
